...
function spawn_model() {
	...
	python3 ${src_path}/Tools/sitl_gazebo/scripts/jinja_gen.py ${src_path}/Tools/sitl_gazebo/models/${MODEL}.sdf.jinja --mavlink_tcp_port 4560 --mavlink_udp_port 14560 --output-file /tmp/${MODEL}_${N}.sdf
